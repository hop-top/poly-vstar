...
byte form (`canonical.Calendar`). Implementations that agree on
canonical bytes — the Go reference and the TypeScript, Python, Rust
and PHP ports, cross-validated by the parity gate — produce
