 ...
 * syntactically valid RFC values that this scope defers, so they are
 * rejected at parse with `ErrUnsupportedRRule` rather than modelled.
 */
export type Freq = "INVALID" | "HOURLY" | "DAILY" | "WEEKLY" | "MONTHLY" | "YEARLY";
