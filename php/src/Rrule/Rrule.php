 ...
 * `HOURLY`, `DAILY`, `WEEKLY`, `MONTHLY` or `YEARLY`, with `INTERVAL`,
 * `UNTIL` (UTC form #2 only), `COUNT`, every `BY-*` clause, and `WKST`.
 * `FREQ=SECONDLY`, `FREQ=MINUTELY` and `RSCALE` are recognized by name
 * and reported `ErrUnsupportedRRule`.
 *
