...
/// uppercased, so there is no substring of the input to hand back.
/// `docs/dev/api-mapping.md` spells the Rust return as `Option<String>`
/// for that reason — a borrowed `&str` cannot express an uppercased
/// result.
