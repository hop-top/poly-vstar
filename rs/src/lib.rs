...
//! machine, in any year.
//!
//! **Status: every layer implemented.** The in-memory model, both wire
//! codecs, canonicalization, hashing, TZID resolution, durations, the
//! extension namespace, the helper surfaces, supersession, diff, the
//! streaming codecs, recurrence and validation all ship; see
//! `docs/dev/porting-guide.md` for the layer map.
//!
//! # Example
//!
//! ```
