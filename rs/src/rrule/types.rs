...
/// The `FREQ` rule-part.
///
/// `SECONDLY` and `MINUTELY` are deliberately absent: they are outside
/// the v0.1 scope, and the parser reports them as
/// [`Error::UnsupportedRRule`](crate::Error::UnsupportedRRule) rather
/// than modelling them as variants nothing can evaluate.
///
