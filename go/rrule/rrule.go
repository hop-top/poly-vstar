...
// are in scope; FREQ=SECONDLY, FREQ=MINUTELY, and RSCALE are not).
//
// Scope (spec/03 §RRULE parsing scope):
//
...
// ErrUnsupportedRRule (spec/03 §RRULE parsing scope).
//
...
// from the v0.2 surface — at v0.2 ship that is FREQ=SECONDLY,
// FREQ=MINUTELY, and RSCALE.
//
...
// deliberately omitted from v0.2 (spec/03 §RRULE parsing scope); the parser
